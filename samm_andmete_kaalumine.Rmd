...
```{r eval = FALSE, fig.cap = "Joonis 1. Kreekas internetti igapäevaselt kasutavate inimeste osakaalu punkt- ja vahemikhinnang (usaldusnivool 95%) eri kaalumise seadete korral."}
library(showtext)
...
ggplot(aes(y = meetod, x = prop)) +
  ...
  labs(x = "Osakaal (%)",
       y = "Kaalumismeetod",
       caption = "Andmed: ESS 10. küsitluslaine") +
  theme_bw(base_family = "Rubik", base_size = 20,
           base_line_size = 0.5, base_rect_size = 0.5) +
  theme(axis.text = element_text(lineheight = 0.5))
```
